...
> 本分支为 **26.1 Fabric 版本**，以 26.1.2 开发，使用 HaloCore 2.4.1 / adapter.2。YSM 与 Connector 不在本次范围；用户已确认网络和本次渲染问题测试通过；三版本完整运行矩阵尚未完成。实际验证范围见 [迁移记录](docs/26.1-fabric-migration.md)，下文继承的功能文档不代表所有项目已在本平台验收。

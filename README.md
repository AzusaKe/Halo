...
The compiled JAR is under `build/libs/`; this source version builds `halo-1.21.1-fabric-2.4.0+adapter.2.jar`. Builds from modified or unpinned worktrees carry a `.dev` suffix. See the [release checks](DEVELOPMENT.md).

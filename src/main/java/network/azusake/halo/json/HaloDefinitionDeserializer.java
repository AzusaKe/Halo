...
public class HaloDefinitionDeserializer implements JsonDeserializer<HaloDefinition> {
    ...
    private HaloGroup parseGroup(JsonObject obj) {
        ...
        Vec3 position = obj.has("position")
            ? gson.fromJson(obj.get("position"), Vec3.class)
            : Vec3.ZERO;
    ...
    private List<HaloGroup> convertLegacyShape(JsonObject shapeObj) {
        ...
        switch (type) {
            case "billboard" -> {
                ...
                groups.add(new HaloGroup(Vec3.ZERO, bp));
            }
    ...
    private HaloPositioning parsePositioning(JsonObject obj) {
        if (obj == null) return new HaloPositioning(Vec3.ZERO, 1.0);
        Vec3 offset = gson.fromJson(obj.get("offset"), Vec3.class);
    ...
    private static class Vec3dAdapter implements JsonDeserializer<Vec3>, JsonSerializer<Vec3> {
        @Override

...
public final class HaloRenderListener {
    ...
    public static void register(){
        ...
        LevelRenderEvents.AFTER_SOLID_FEATURES.register(context->HaloRenderer.getInstance().renderHalos(context.poseStack(),Minecraft.getInstance().gameRenderer.getMainCamera(),tickDelta));
    }
}

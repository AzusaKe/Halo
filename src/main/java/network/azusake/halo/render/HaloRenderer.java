...
public final class HaloRenderer {
    ...
    public void renderHalos(PoseStack matrices, SubmitNodeCollector collector,
        ...
        try {
            ...
            // Submit only the entity RenderTypes used by Halo. Minecraft's
            // feature renderer owns upload, sorting and draw state.
     ...
     * used by the halo geometry to the 26.2 submit-node renderer.
     *

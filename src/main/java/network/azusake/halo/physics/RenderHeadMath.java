...
public final class RenderHeadMath {
     ...
     */
    public static AnchorPose toAnchorPose(RenderHeadCapture.CapturedHead captured, Vec3 cameraPos, Matrix4f viewMatrix) {
    ...
    public static AnchorPose toAnchorPose(Matrix4f head, Vec3 cameraPos) {

 ...
 * per entity at submit time ({@link #registerPlayer}), then — because 26.2
 ...
 * for one following frame because 26.2 draws player models after Halo's
 * {@code COLLECT_SUBMITS} lookup.  Iris shadow-pass captures are

...
/** Runtime symbols shared by the verified EMF 26.3 ABI family. */
public final class Emf263Symbols {
    ...
    public static final String VANILLA_MODEL_PART = "traben.entity_model_features.models.parts.EMFModelPartVanilla";

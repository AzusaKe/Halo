...
public final class EmfMixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        ...
        try {
            ...
            namedRuntime = "named".equals(net.fabricmc.loader.api.FabricLoader.getInstance()
            ...
            if (!apply) {
                ...
                LOGGER.info(
                    ...
                    installed.get(), namedRuntime ? "named" : "intermediary");
            }

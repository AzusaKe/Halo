...
/** Runtime symbols for the 26.1 EMF render ABI family. */
public final class Emf261Symbols {
    ...
    /** Mojang-named render method used by the 26.1 development runtime. */
    public static final String RENDER_METHOD_NAMED = "render";

    /** Fabric production name retained by the 26.1 intermediary ABI. */
    public static final String RENDER_METHOD_INTERMEDIARY = "method_22699";

    /** 26.1 Mojang-named render overload with packed colour. */
    public static final String RENDER_DESCRIPTOR_NAMED =
        "(Lcom/mojang/blaze3d/vertex/PoseStack;"
            + "Lcom/mojang/blaze3d/vertex/VertexConsumer;III)V";

    /** 26.1 intermediary render overload with packed colour. */

...
public final class EmfHeadMath {
    ...
    /**
     * EMF 3.3.6+ does not expose a stable getPartName ABI.  The verified
     * 26.3 ABI keeps the vanilla part name on EMFModelPartVanilla, so the
     * optional field-access mixin is the authoritative head anchor here.
     */
    public static boolean isHeadPart(ModelPart part) {
        // 26.3's official ModelPart mapping is final, so a direct instanceof

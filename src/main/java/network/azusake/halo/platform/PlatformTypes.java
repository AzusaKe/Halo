...
public final class PlatformTypes {
    ...
    public static net.minecraft.resources.ResourceLocation game(Identifier id) { return net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(id.getNamespace(),id.getPath()); }

...
public final class HaloScepterSessionStore {
    ...
    public record Session(UUID playerUuid, UUID targetUuid, ResourceLocation worldId) {
    }

    private final Map<UUID, Session> sessions = new ConcurrentHashMap<>();

    public void open(UUID playerUuid, UUID targetUuid, ResourceLocation worldId) {

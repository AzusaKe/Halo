...
class HaloDataTest {
    ...
    class CoreRecords {
        ...
        void definition() {
            ResourceLocation id = new ResourceLocation("halo", "test");
            BillboardPrimitive bp = new BillboardPrimitive(
                new ResourceLocation("halo", "tex"),
                new Vector2f(1, 1)
            );
    ...
    class InstanceTests {
        ...
        void currentAnimTimeFreshUsesRawElapsed() {
            HaloInstance inst = new HaloInstance(
                java.util.UUID.randomUUID(), new ResourceLocation("halo", "ring_default"));
        ...
        void currentAnimTimeMatchesRenderedIdlePhase() {
            ...
            HaloInstance inst = new HaloInstance(
                java.util.UUID.randomUUID(), new ResourceLocation("abydos", "shiroko"));
            StartupAnimationConfig cfg = startupConfig(7.0);
    ...
    class ShapeTests {
        ...
        void billboardIsHaloPrimitive() {
            BillboardPrimitive b = new BillboardPrimitive(
                new ResourceLocation("halo", "ring"),
        ...
        void modelGroupsOrder() {
            var bp1 = new BillboardPrimitive(new ResourceLocation("halo", "a"), new Vector2f(1, 1));
            var bp2 = new BillboardPrimitive(new ResourceLocation("halo", "b"), new Vector2f(2, 2));
    ...
    class JsonRoundTrip {
        ...
        void identifierAdapterRoundTrip() {
            ResourceLocation original = new ResourceLocation("halo", "textures/halo/ring");
            String serialized = gson.toJson(original);

...
class EntityHaloTrackerTest {
    ...
    class NbtRoundTrip {
        ...
        void testAttachHasReadRemove() {
            ...
            ResourceLocation defId = new ResourceLocation("halo", "ring_default");
        ...
        void testMalformedDefinition() {
            ...
            assertThrows(Exception.class, () -> {
                new ResourceLocation(persistent.getCompound("HaloInstance").getString("Definition"));
        ...
        void testMultipleEntities() {
            ...
            ResourceLocation def1 = new ResourceLocation("halo", "ring_a");
            ResourceLocation def2 = new ResourceLocation("halo", "ring_b");
    ...
    class HaloEntryRecord {
        ...
        void testHaloEntry() {
            UUID uuid = UUID.randomUUID();
            ResourceLocation defId = new ResourceLocation("halo", "ring_test");

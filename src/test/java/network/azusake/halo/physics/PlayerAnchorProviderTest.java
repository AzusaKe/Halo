...
class PlayerAnchorProviderTest {
    ...
    class ProfileFallback {
        ...
        void testDirectMatch() {
            ...
            var profile = new network.azusake.halo.data.EntityAnchorProfile(
                new net.minecraft.resources.ResourceLocation("minecraft:player"),
                "standing",
    ...
    // ------------------------------------------------------------------
    // 6. Pose key resolution (pure decision, no Minecraft instance)
    // ------------------------------------------------------------------

    @Nested
    @DisplayName("Pose key resolution (airborne sneaking keeps standing)")
